...
docs/sids.tsv:
	curl -v "https://projekte.ub.uni-leipzig.de/projects/metadaten-quellen/wiki/SIDs.xml?key=$$REDMINE_API_KEY" | xmlcutty -path /wiki_page/text | sed -e 's/|/\t/g; s/^[ \t]*//; s/"/\\"/g' | cut -f1-3 | tail -n +4 > $@
