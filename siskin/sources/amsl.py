...
class AMSLFilterConfigPatched(AMSLTask):
    ...
    def run(self):
        ...
        b = """{"and":[{"source":["49"]},{"holdings":{"urls":["https://live.amsl.technology/OntoWiki/files/get?setResource=http://amsl.technology/discovery/metadata-usage/Dokument/KBART_23FIDBBI_2022_04_07"]}}]}"""
