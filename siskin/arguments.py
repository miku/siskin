...
class FincArgumentParser():
    ...
    def __init__(self, config=None):
        ...
        self.parser.add_argument("-i", "--input", dest="inputfilename", help="inputfile")
        ...
        self.parser.add_argument("--format", dest="outputformat", help="outputformat mrc or xml", default="mrc")
